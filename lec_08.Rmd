...
teams %>% 
  filter(yearID == 2018) %>% 
  ggplot(mapping = aes(x = BB + H, y = SO)) +
  geom_point()
```
]
...
teams %>% 
  filter(yearID == 2018) %>% 
  ggplot(mapping = aes(x = BB + H, y = SO, color = factor(Rank), shape = factor(Rank))) + #<<
...
**How can we improve this visualization if our goal is investigate the role
strikeouts and runs play for division winners and non-division winners?**
...
.tiny[
```{r fig.align='center', fig.width=9, fig.height=6}
ggplot(teams[teams$yearID == 2018, ], 
       mapping = aes(y = W, x = forcats::fct_reorder(franchID, W, .desc = TRUE))) + #<<
...
<a href="http://www2.stat.duke.edu/courses/Spring21/sta323.001/files/novartis.pdf"><img src="images/novartis1.png"></a>

---

<a href="http://www2.stat.duke.edu/courses/Spring21/sta323.001/files/novartis.pdf"><img src="images/novartis2.png"></a>
...
1. Grolemund, G., & Wickham, H. (2021). R for Data Science. R4ds.had.co.nz.
   https://r4ds.had.co.nz/data-visualisation.html

2. https://ggplot2.tidyverse.org/reference/

3. Lahman, S. (2021) Lahman's Baseball Database, 1871-2018, Main page,
