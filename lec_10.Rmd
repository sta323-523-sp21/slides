...
```{r}
str_extract_all("show.me.the.dots...", "\\.")
```
...
*Many base R functions require classes to be wrapped in a second set of 
`[ ]`, e.g. `[[:digit:]]`.*
...
2. Regular expressions. (2021). Stringr.tidyverse.org.
